...
## Launcher — shoulder bar (authoritative pair)

| Asset | Role |
|-------|------|
| [`launcher/output/radr-bazooka-authoritative-stowed.png`](launcher/output/radr-bazooka-authoritative-stowed.png) | **Stowed** — user-painted |
| [`launcher/output/radr-bazooka-authoritative-deployed.png`](launcher/output/radr-bazooka-authoritative-deployed.png) | **Deployed (12→6)** — user-painted |
